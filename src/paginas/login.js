                ...
                <div>
                    <div className="container-fluid logincont">
                            ...
                            <form onSubmit={this.submeterForm} className="form-group">
                                ...
                                <div className="form-row justify-content-center d-none d-md-block">
                                    <div className="input-group mb-3 justify-content-center">
                                        ...
                                        <input className="col-sm-12 col-md-5 form-control-md" type="email" value={this.state.email} onChange={this.alterarUsername} placeholder="Digite seu email" />
                                        <input className="col-sm-12 col-md-4 form-control-md" type="password" value={this.state.password} onChange={this.alterarPassword} placeholder="Digite sua senha" />
                         ...
                         */}
                            ...
                            <form> {/**formulário com os switchs para escolher se quer um cadastro de cliene ou prestado de serviços */}
